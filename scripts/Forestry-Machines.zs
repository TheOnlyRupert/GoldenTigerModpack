...
mods.forestry.ThermionicFabricator.addCast(<LogisticsPipes:item.logisticsHUDGlasses>, [[<LogisticsPipes:item.logisticsParts:0>, null, <LogisticsPipes:item.logisticsParts:0>], [<LogisticsPipes:item.logisticsParts:1>, <LogisticsPipes:item.logisticsParts:2>, <LogisticsPipes:item.logisticsParts:1>]], 10000, null);
mods.forestry.ThermionicFabricator.addCast(<LogisticsPipes:item.logisticsParts:0>, [[<minecraft:diamond>, <minecraft:diamond>, <minecraft:diamond>], [null, null, <BuildCraft|Silicon:redstoneChipset:3>]], 1000, null);
mods.forestry.ThermionicFabricator.addCast(<LogisticsPipes:item.logisticsParts:1>, [[<minecraft:glowstone_dust>, <BuildCraft|Silicon:redstoneChipset:3>, <minecraft:glowstone_dust>], [<minecraft:glowstone_dust>, <ore:blockGlass>, <minecraft:glowstone_dust>], [<minecraft:glowstone_dust>, <minecraft:glowstone_dust>, <minecraft:glowstone_dust>]], 1000, null);
mods.forestry.ThermionicFabricator.addCast(<LogisticsPipes:item.logisticsParts:2>, [[null, <BuildCraft|Silicon:redstoneChipset:3>, null], [<minecraft:diamond>, null, <minecraft:diamond>]], 1000, null);
