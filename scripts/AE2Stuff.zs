...
recipes.addShaped(<ae2stuff:Encoder>, [[<ore:plateTitanium>, <appliedenergistics2:item.ItemMultiPart:340>, <ore:plateTitanium>], [<appliedenergistics2:item.ItemMultiMaterial:23>, <appliedenergistics2:tile.BlockCraftingUnit>, <appliedenergistics2:item.ItemMultiMaterial:23>], [<ore:plateTitanium>, <appliedenergistics2:item.ItemMultiPart:16>, <ore:plateTitanium>]]);
...
[<ThermalExpansion:wrench:*>, <appliedenergistics2:item.ItemMultiMaterial:24>, <ThermalExpansion:wrench:*>]]);

// --- Advanced Inscriber
recipes.addShaped(<ae2stuff:Inscriber>, [
[<ore:plateTitanium>, <appliedenergistics2:item.ItemMultiMaterial:24>, <ore:plateTitanium>],
