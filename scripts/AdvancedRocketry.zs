...
recipes.addShaped(<libVulpes:blockStructureBlock>, [[<libVulpes:libVulpesmetal0:7>, <ThermalFoundation:material:139>, <libVulpes:libVulpesmetal0:7>], [null, <rftools:machineFrame>, null], [<libVulpes:libVulpesmetal0:7>, null, <libVulpes:libVulpesmetal0:7>]]);
...
# New Rocket Assembling Machine
recipes.remove(<advancedRocketry:rocketBuilder>);
recipes.addShaped(<advancedRocketry:rocketBuilder>, [[<ThaumicTinkerer:kamiResource:2>, <AWWayofTime:masterBloodOrb>.noReturn(), <ThaumicTinkerer:kamiResource:2>], [<libVulpes:libVulpescoil0:2>, <libVulpes:tile.advStructureMachine>, <libVulpes:libVulpescoil0:2>], [<libVulpes:libVulpesproductgear:7>, <simplyjetpacks:jetpacks:5>.onlyWithTag({Energy: 60000000}), <libVulpes:libVulpesproductgear:7>]]);
