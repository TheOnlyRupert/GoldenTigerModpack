...
# Rename love block -> "Pure Mana Block"
//<ExtraUtilities:pureLove>.displayName = "Pure Mana Block";

# New 'Ender Block' Recipe
recipes.addShaped(<ExtraUtilities:enderThermicPump>, [[<ExtraUtilities:decorativeBlock1:1>, <minecraft:diamond>, <ExtraUtilities:decorativeBlock1:1>], [<StevesCarts:ModuleComponents:45>, <BuildCraft|Factory:pumpBlock>, <StevesCarts:ModuleComponents:45>], [<ExtraUtilities:decorativeBlock1:1>, <ExtraUtilities:pipes:0>, <ExtraUtilities:decorativeBlock1:1>]]);
...
# New Drum Recipes (Use Buildcraft Assembly Table)
//recipes.addShaped(<ExtraUtilities:drum:0>, [[<TConstruct:materials:16>, <minecraft:heavy_weighted_pressure_plate>, <TConstruct:materials:16>], [<TConstruct:materials:16>, <ThermalExpansion:Tank:3>, <TConstruct:materials:16>], [<TConstruct:materials:16>, <minecraft:heavy_weighted_pressure_plate>, <TConstruct:materials:16>]]);
//recipes.addShaped(<ExtraUtilities:drum:1>, [[<ExtraUtilities:bedrockiumIngot>, <minecraft:light_weighted_pressure_plate>, <ExtraUtilities:bedrockiumIngot>], [<ExtraUtilities:bedrockiumIngot>, <ExtraUtilities:drum:0>, <ExtraUtilities:bedrockiumIngot>], [<ExtraUtilities:bedrockiumIngot>, <minecraft:light_weighted_pressure_plate>, <ExtraUtilities:bedrockiumIngot>]]);
...
<ExtraUtilities:spike_base>.displayName="Invar Spike";
...
recipes.addShaped(<ExtraUtilities:generator:5>, [[<minecraft:iron_block>, <minecraft:iron_block>, <minecraft:iron_block>], [<minecraft:iron_block>, <ExtraUtilities:generator:10>, <minecraft:iron_block>], [<BuildCraft|Core:engineBlock:1>, <minecraft:sticky_piston>, <BuildCraft|Core:engineBlock:1>]]);
recipes.addShaped(<ExtraUtilities:generator:11>, [[<minecraft:skull:1>, <ForbiddenMagic:StarBlock>, <minecraft:skull:1>], [<minecraft:skull:1>, <ExtraUtilities:generator:8>, <minecraft:skull:1>], [<Railcraft:machine.beta:9>, <minecraft:sticky_piston>, <Railcraft:machine.beta:9>]]);
